import orientaatioviikko from "../assets/images/other/orientaatioviikko.jpg";
...
export default function Freshmen() {
  return (
    <>
      ...
      />
      <p>
        Tiedossa on rentoa hengailua ja yhteistä toimintaa! Tervetuloa mukaan
        viihtymään, tavataan viimeistään orientaatioviikolla!
      </p>
    </>
  );
}
